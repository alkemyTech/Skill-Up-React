    ...
    <div className="w-2/5 p-7 bg-cyan-500 rounded">
      <form action="" onSubmit={onSubmit}>
        <div className="flex flex-col gap-3">
          <span className="text-stone-200 text-left">Cuenta de destino:</span>
          <input
            type="text"
            name="toAccountId"
            ref={toAccountIdRef}
        ...
        <div className="mt-4 flex flex-col gap-3">
          <span className="text-stone-200 text-left">Concepto:</span>
          <input
            type="text"
            name="concept"
            ref={conceptRef}
        ...
        <div className="mt-4 flex flex-col gap-3">
          <span className="text-stone-200 text-left">Suma:</span>
          <input
            type="number"
            name="amount"
            ref={amountRef}
