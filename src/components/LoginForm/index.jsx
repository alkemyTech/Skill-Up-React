...
export const LoginForm = () => {
	...
	return (
		<div className="flex items-center justify-center min-h-screen">
			<form
				onSubmit={handleForm}
				className="flex flex-col items-center gap-8 p-8 bg-white rounded-md min-w-[250px] max-w-[450px] w-full"
			>
				...
				<div className="flex flex-col gap-4  w-full">
					<div className="flex flex-col items-start w-full gap-1">
						...
						<input
							...
							className="border border-black rounded-md w-full py-2 px-4 text-sm"
						/>
						{email?.length ? (
					...
					<div className="flex flex-col items-start w-full gap-1">
						...
						<div className="relative w-full">
							<input
								...
								className="border border-black rounded-md w-full py-2 px-4 text-sm pr-16"
							/>
				...
				<div className="flex flex-col items-center gap-2 w-full">
					...
					<Text as="a" className="text-ct-primary-300 text-[12px]">
						Forgot my password
					</Text>
				</div>
			</form>
