...
function ListSkeleton({rows}) {
    ...
    return (
    <div role="status" className="mx-auto opacity-10 p-4 space-y-4 max-w-md rounded border border-gray-200 divide-y divide-gray-200 shadow animate-pulse dark:divide-gray-500 md:p-6 dark:border-gray-500">
