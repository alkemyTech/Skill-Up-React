    ...
    <div className='mb-6'>
      ...
      <div className="relative rounded-md mt-1 shadow-sm overflow-hidden">
        ...
        <input
          ...
          min={0}
          step={100}
          className="block w-full pt-[6px] pb-[4px] z-[10] pl-6 border-[1px] z-[10] rounded-md border-indigo-300 focus:outline-indigo-500 focus:ring-indigo-500 focus:outline-[2px] sm:text-sm"
